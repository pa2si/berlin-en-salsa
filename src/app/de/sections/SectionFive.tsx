    ...
    >
      <div className="container mx-auto">
        ...
        <div className="mb-12 flex justify-center">
          <h2 className="sr-only">Festivalplan</h2>
          <motion.img
        ...
        >
          <p className="text-bes-amber mx-auto mb-6 max-w-3xl text-xl font-semibold md:text-2xl">
            Sieh dir unseren interaktiven Zeitplan an und plane dein Berlin En
            Salsa Erlebnis. Klicke auf die Bilder, um den vollständigen Zeitplan
            sowie alle Details zu Künstlern, Workshops und mehr anzuzeigen!
          </p>
        </motion.div>
          ...
          <AnimatePresence mode="wait">
            {activeTab === "saturday" ? (
              <motion.div
                ...
                transition={{ duration: 0.3 }}
              >
                <Link href="/de/timetable?day=saturday">
                  <motion.div
              ...
              <motion.div
                ...
                transition={{ duration: 0.3 }}
              >
                <Link href="/de/timetable?day=sunday">
                  <motion.div
                    className="relative cursor-pointer overflow-hidden rounded-lg shadow-xl"
                    whileHover={{ scale: 1.03 }}
                    whileTap={{ scale: 0.98 }}
        ...
        <div className="mx-auto hidden max-w-5xl gap-8 md:grid md:grid-cols-2">
          ...
          >
            <h3 className="text-bes-amber mb-4 text-2xl font-bold">Samstag</h3>
            <Link href="/de/timetable?day=saturday">
              <motion.div
                className="relative cursor-pointer overflow-hidden rounded-lg shadow-xl"
                whileHover={{ scale: 1.03 }}
          ...
          <motion.div
            ...
            className="flex flex-col items-center"
          >
            <h3 className="text-bes-amber mb-4 text-2xl font-bold">Sonntag</h3>
            <Link href="/de/timetable?day=sunday">
              <motion.div
                className="relative cursor-pointer overflow-hidden rounded-lg shadow-xl"
                whileHover={{ scale: 1.03 }}
