    ...
    <>
      <div className="pointer-events-none absolute inset-0 flex items-center justify-center overflow-hidden">
        <img
          ...
          alt=""
          className="h-[130vh] w-auto max-w-none object-contain opacity-[0.03] select-none"
          aria-hidden="true"
        />
      </div>
