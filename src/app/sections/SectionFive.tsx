    ...
    >
      <div className="container mx-auto">
        ...
        <div className="mb-12 flex justify-center">
          <h2 className="sr-only">Programa del Festival</h2>
          <motion.img
            src="/timetable-amber.svg"
            alt="Programa del Festival"
        ...
        >
          <p className="text-bes-amber mx-auto mb-6 max-w-3xl text-xl font-semibold md:text-2xl">
            Consulta nuestro horario interactivo y planifica tu experiencia en
            Berlin En Salsa. Haz clic en las imágenes para ver el horario
            completo y todos los detalles sobre los artistas, talleres y mucho
            más.
          </p>
        </motion.div>
        ...
        <div className="mx-auto hidden max-w-5xl gap-8 md:grid md:grid-cols-2">
          ...
          >
            <h3 className="text-bes-amber mb-4 text-2xl font-bold">Sábado</h3>
            <Link href="/timetable?day=saturday">
              <motion.div
                className="relative cursor-pointer overflow-hidden rounded-lg shadow-xl"
                whileHover={{ scale: 1.03 }}
          ...
          <motion.div
            ...
            className="flex flex-col items-center"
          >
            <h3 className="text-bes-amber mb-4 text-2xl font-bold">Domingo</h3>
            <Link href="/timetable?day=sunday">
              <motion.div
                className="relative cursor-pointer overflow-hidden rounded-lg shadow-xl"
                whileHover={{ scale: 1.03 }}
