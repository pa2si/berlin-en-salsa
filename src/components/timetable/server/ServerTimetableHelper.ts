  ...
  static async getTimetableData(
    ...
    const translateColumnArea = (area: string) => {
      ...
      const areaKeyMap: Record<string, string> = {
        ...
        "Tanz-Workshops": "danceArea",
        "Tanz Area": "danceArea",
        Tanzbühne: "danceArea",
        "Talleres de Baile": "danceArea",
        "Zona de Baile": "danceArea",
        "Tarima de baile": "danceArea",
        "Dance Workshops": "danceArea",
        "Musik-Workshops": "musicWorkshops",
        Workshops: "musicWorkshops",
        "Talleres de Música": "musicWorkshops",
        Talleres: "musicWorkshops",
    ...
    const getOriginalAreaKey = (translatedArea: string) => {
      ...
      const reverseMap: Record<string, string> = {
        ...
        "Tanz-Workshops": "dance-area",
        "Talleres de Baile": "dance-area",
        "Dance Workshops": "dance-area",
        "Tanz Area": "dance-area",
        Tanzbühne: "dance-area",
        "Zona de Baile": "dance-area",
        "Tarima de baile": "dance-area",
        "Musik-Workshops": "music-workshops",
        Workshops: "music-workshops",
        "Talleres de Música": "music-workshops",
        Talleres: "music-workshops",
