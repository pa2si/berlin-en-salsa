...
### Type Guards
```typescript
export function isMainStageEvent(event: TimetableEvent): event is MainStageEvent
export function isDanceWorkshopEvent(event: TimetableEvent): event is DanceWorkshopEvent
// ... etc.
```
