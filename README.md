...
- Eloy Rojas Project added to dance performances

v3.6.37

- corrected texts for jessy and helen dance performances

v3.6.36

- now performances in Timetable active

v3.6.35

- modified legal page and added all necessary infos
...
- Location start in small letter
...
- Now possble to display overlapping slots in timeline

v3.6.21

- instead of max 40 caracters in slot title, now 50 caracters
...
v2.0.4 gallery-slider v0.3

- small hover adaptions

v2.0.4 gallery-slider v0.2
...
SectionThree visibility now also gets controlled in festival.ts
